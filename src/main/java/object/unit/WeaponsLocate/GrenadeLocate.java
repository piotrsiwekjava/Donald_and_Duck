...
public class GrenadeLocate implements WeaponLocate{
    public GrenadeLocate(){}
    ...
    public void set_Odds_draw_Left(BodyPart[] bodyParts, Weapon weapon, double[] size) {
        ...
        weapon.setOdds_draw(-size[0]*0.35,size[1]*0.35);
//        weapon.setOdds_draw(-size[0]*0.0,size[1]*0.0);
        weapon.set_odds_from_barrelTip_to_Center(-size[0]*0.45,size[1]*0.38);
    }
    ...
    public void set_Odds_draw_Right(BodyPart[] bodyParts, Weapon weapon, double[] size) {
        bodyParts[4].setOdds_draw(-size[0]*0.3,-size[1]*0.1);
        bodyParts[5].setOdds_draw(-size[0]*0.3,-size[1]*0.1);
        weapon.setOdds_draw(size[0]*0.15,size[1]*0.35);
//        weapon.setOdds_draw(size[0]*0.0,size[1]*0.0);
        weapon.set_odds_from_barrelTip_to_Center(size[0]*0.50,size[1]*0.38);
    }
}
